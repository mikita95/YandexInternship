...
public class ReflectionJdbcDaoImpl<T> implements ReflectionJdbcDao<T> {
    ...
    /**
     * Returns {@link List} of {@link Field}s by annotations of the object
     *
    ...
    /**
     * Returns {@link List} of key {@link Field}s by annotations of the object
     *
    ...
    /**
     * Returns {@link List} of key  {@link Field}s by annotations of the class
     *
    ...
    /**
     * Returns {@link List} of {@link Field}s by specified annotations of the object
     *
     * @param object      is used to take fields
     * @param annotations annotations that are used to take fields
     * @return {@link List} of {@link Field}s that was annotated
     */
    ...
    /**
     * Returns {@link List} of {@link Field}s by specified annotations of the class
     *
     * @param clazz       is used to take fields
     * @param annotations annotations that are used to take fields
     * @return {@link List} of {@link Field}s that was annotated
